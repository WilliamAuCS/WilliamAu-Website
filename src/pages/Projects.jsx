                    ...
                    <div className="container">
                        <div>
                            ...
                            <div className="projectSideBar">
                                ...
                                <img src={require('../images/Mysteria1.PNG')} height="200" width="200" alt="Mysteria" 
                                title="Example picture of my in progress Mysteria RPG game"/>
                                </div>

                                <img src={require('../images/object_cube.png')} height="200" width="200" alt="Cube Runner" 
                                title="Example picture of my first completed game"/>

                                <img src={require('../images/react-logo.png')} height="200" width="200" alt="My Website" 
                                title="I used the JavaScript library React to complete this website"/>
